...
export default class Resource {
  ...
  address ({ mapArgs = null, ...options }) {
    ...
    const addressOptions = parseOpts(options, this.options);

    return (...args) => {
      const { params } = parseOpts(mapArgs(...args), addressOptions);

      return this.requestUrl.format(params);
    };
  }
